...
import { ROOMS, ENVIRONMENT_INFO, MENU_HIGHLIGHTS, HOTEL_CONDITIONS, HOTEL_SERVICES, REVIEWS } from './constants';
            ...
            <div className="pt-20 bg-stone-50 min-h-screen">
               ...
               <div className="max-w-4xl mx-auto px-4 py-16">
                    <div className="bg-white p-8 md:p-12 shadow-lg rounded-sm border border-stone-100">
                        <h2 className="text-center text-3xl font-serif font-bold text-stone-800 mb-12 uppercase tracking-widest border-b pb-4">Nuestros Platos Estrella</h2>
                        <div className="space-y-8">
                            {MENU_HIGHLIGHTS.map((item, idx) => (
                                <div key={idx} className="flex justify-between items-baseline border-b border-stone-100 pb-4 last:border-0">
                                    <div className="pr-4">
                                        <h3 className="text-xl font-bold text-stone-800">{item.name}</h3>
                                        <p className="text-stone-500 italic mt-1">{item.desc}</p>
                                    </div>
                        ...
                        <div className="mt-12 text-center">
                            <p className="text-sm text-stone-500 mb-4">* Disponemos de menú del día y menú especial fin de semana.</p>
                            <button onClick={() => window.location.href="tel:+34681279508"} className="bg-stone-800 text-white px-8 py-3 rounded-sm hover:bg-stone-700 transition">
                                Reservar Mesa
                            </button>
                        </div>
                    </div>
